...
export function createKycRouter(): Router {
  ...
  router.post('/submit', jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  ...
  router.get('/status', jwtAuthMiddleware, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
