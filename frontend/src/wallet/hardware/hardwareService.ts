...
const MOCK_ACCOUNTS: HardwareAccount[] = [
  {
    index: 0,
    path: "m/44'/148'/0'",
    publicKey: 'GBD4I7Q6C3...',
    address: 'GBD4I7Q6C3KJDHFJ2D4J3H8K9A1B2C3D4E5F6G7H8',
    label: 'Account 1',
  },
  {
    index: 1,
    path: "m/44'/148'/1'",
    publicKey: 'GA6J2K7D8F...',
    address: 'GA6J2K7D8F9L0P1Q2R3S4T5U6V7W8X9Y0Z1A2B3C',
    label: 'Account 2',
  },
  {
    index: 2,
    path: "m/44'/148'/2'",
    publicKey: 'GC3M9N1B5V...',
    address: 'GC3M9N1B5V7C8X9Z0A1B2C3D4E5F6G7H8I9J0K1L',
    label: 'Account 3',
  },
];
...
export async function connectToDevice(device: HardwareDeviceInfo): Promise<boolean> {
  ...
  throw new Error(
    `Failed to connect to ${device.name}. Make sure Bluetooth is enabled and the device is unlocked.`
  );
}
