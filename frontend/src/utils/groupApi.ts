    ...
    cycles: [
      {
        ...
        targetAmount: group.memberCount * group.contributionAmount,
        currentAmount: group.memberCount * group.contributionAmount,
        status: 'completed',
      },
      {
        cycleNumber: 2,
        ...
        targetAmount: group.memberCount * group.contributionAmount,
        currentAmount: group.memberCount * group.contributionAmount * 0.75,
        status: 'active',
      },
    ],
    currentCycle: {
