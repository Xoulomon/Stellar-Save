...
export default function FeedbackAdminPage() {
  ...
  useEffect(() => {
    load();
  }, [filterCat, filterStatus]); // eslint-disable-line react-hooks/exhaustive-deps
        ...
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
          <FormControl size="small" sx={{ minWidth: 140 }}>
            ...
            >
              ...
              {['bug', 'feature', 'general', 'other'].map((c) => (
                  ...
                  <>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        ...
                        <Button variant="contained" size="small" onClick={() => respond(item.id)}>
                          Save
                        </Button>
                        <Button size="small" onClick={() => setResponding(null)}>
                          Cancel
                        </Button>
                      </Box>
                    </Box>
