...
const ACTIONS = [
  {
    ...
    icon: <AddIcon />,
    color: 'primary',
    dialogTitle: 'Join a Group',
    placeholder: 'Group ID or invite code',
  },
  {
    id: 'contribute' as ActionId,
    label: 'Make Contribution',
    icon: <PaymentIcon />,
    color: 'secondary',
    dialogTitle: 'Make a Contribution',
    placeholder: 'Amount in XLM',
  },
  {
    id: 'deposit' as ActionId,
    label: 'Buy Crypto',
    icon: <AccountBalanceIcon />,
    color: 'success',
    dialogTitle: 'Buy Crypto',
    placeholder: 'Amount in USD',
  },
  {
    id: 'withdraw' as ActionId,
    label: 'Sell Crypto',
    icon: <AccountBalanceIcon />,
    color: 'warning',
    dialogTitle: 'Sell Crypto',
    placeholder: 'Amount in USD',
  },
];
