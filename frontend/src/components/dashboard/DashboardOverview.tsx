    ...
    return (
      <Paper
        ...
        sx={{
          p: 4,
          borderRadius: 4,
          background: 'linear-gradient(135deg, #1f4fd4 0%, #173b9f 100%)',
        }}
      >
  ...
  return (
    <Paper
      ...
      sx={{
        ...
        background: 'linear-gradient(135deg, #1f4fd4 0%, #173b9f 100%)',
        color: 'white',
        boxShadow: '0 8px 32px rgba(31,79,212,0.2)',
      }}
    >
      <Stack
      ...
      >
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="h3" fontWeight="900">
            ...
            <Typography component="span" variant="h5" sx={{ opacity: 0.75 }}>
              {stats.currency}
            </Typography>
          </Typography>
        </Box>
        <Box sx={{ flex: 1 }}>
          ...
          <Stack direction="row" alignItems="baseline" spacing={1} flexWrap="wrap">
            <Typography variant="h4" fontWeight="bold">
              {stats.nextPayoutAmount.toLocaleString()} {stats.currency}
            </Typography>
            <Typography variant="body1" sx={{ opacity: 0.75 }}>
              on {stats.nextPayoutDate}
            </Typography>
          </Stack>
        </Box>
      </Stack>
